...
Plugin URI: http://lumens.se/wp/compact-admin/
...
{
	echo '<link rel="stylesheet" type="text/css" href="/wp-content/plugins/' . basename(dirname(__FILE__)) . '/media/css/compact-admin.css" />';
}
